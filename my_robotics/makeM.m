...
in1=subs(in1,xdot_,vpa(0));
in1=subs(in1,ydot_,vpa(0));
in1=subs(in1,thdot1_,vpa(0));
in1=subs(in1,thdot2_,vpa(0));
in1=subs(in1,thdot3_,vpa(0));
in1=subs(in1,thdot4_,vpa(0));
